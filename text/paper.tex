...
\title{KDE: Requirements, Processes and Architecture
	\titlenote{(Produces the permission block, and
copyright information). For use with
SIG-ALTERNATE.CLS. Supported by ACM.}}
\subtitle{[An overview of the KDE Project]}
%
...
\alignauthor
Stefan Schnack\\
       \email{st140187@stud.uni-stuttgart.de}
}
...
\keywords{KDE, Requirements, Preosses, Architecture}
